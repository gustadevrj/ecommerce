								...
								<div class="col-md-12">
									...
									<div class="woocommerce-billing-fields">
										...
										<div class="row">
											...
											<div class="col-sm-3">
												<p id="billing_number_1_field" class="form-row form-row-wide number-field validate-required">
													...
													<input type="text" value="<?php echo htmlspecialchars( $address["desnumber"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" placeholder="Número" id="billing_number_1" name="desnumber" class="input-text ">
												</p>
											</div>
										</div>
										...
										<div id="order_review" style="position: relative;">
											...
											<p id="billing_payment_field" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field ">
												<input type="radio" checked="checked" id="method-boleto" name="payment-method" value="0" style="float: left; margin: 30px;">
