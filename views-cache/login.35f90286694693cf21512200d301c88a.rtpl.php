            ...
            <div class="col-md-6">
                ...
                <form id="register-form-wrap" action="/register" class="register" method="post">
					...
					<p class="form-row form-row-first">
                        ...
                        <input type="text" id="login" name="login" class="input-text" value="<?php echo htmlspecialchars( $registerValues["login"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                    </p>
                    <p class="form-row form-row-first">
                    ...
                    <p class="form-row">
                        <input type="submit" value="Criar Conta" name="btn_login" class="button">
                    </p>
